...
**This page refers to version 0.6.0 of the Snowplow Ruby Tracker. Documentation for other versions is available:**
...
As of version 0.6.0, providing a `SnowplowTracker::TrueTimestamp` object as the timestamp argument will attach a true timestamp to the event, replacing the device timestamp.
