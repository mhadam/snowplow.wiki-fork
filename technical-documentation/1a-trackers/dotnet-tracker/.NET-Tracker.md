...
This page refers to version 1.0.0 of the Snowplow .NET Tracker. For previous releases up to 0.1.2, please [see here](https://github.com/snowplow/snowplow/wiki/.NET-Tracker-0.1.2).
